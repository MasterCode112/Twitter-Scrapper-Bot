...
about = {}
if not VERSION:
    with open(os.path.join(here, 'Twitter-Scrapper', '__version__.py')) as f:
        exec(f.read(), about)
else:
...
setup(
  ...
  author_email = 'dvdgodbless111@gmail.com',
  url = 'https://github.com/MasterCode112/Twitter-Scrapper-Bot',
  download_url = 'https://github.com/MasterCode112/Twitter-Scrapper-Bot.git',
